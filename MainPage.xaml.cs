namespace BMI_Calculator_Mobile_App
{
    public partial class MainPage : ContentPage
    {
        ...
        //        if (bmi < 18.5)
        //        {
        //            await DisplayAlert("BMI", "Gender: Male\nBMI: " + bmiString + "\nHealth Satus: Underweight\nReccomendations:\n  -Increase calorie intake with nutrient rich foods (e.g., nuts, lean, protein, whole grains)\n  -Incorporate strength training to build muscle mass.\nConsult a nutritionisit if needed", "OK");
        //        }
        //        else if (bmi >= 18.5 && bmi < 25)
        //        {
        ...
        //        if (bmi < 18)
        //        {
        //            await DisplayAlert("BMI", "Gender: Female\nBMI: " + bmiString + "\nHealth Satus: Underweight\nReccomendations:\n  -Increase calorie intake with nutrient rich foods (e.g., nuts, lean, protein, whole grains)\n  -Incorporate strength training to build muscle mass.\nConsult a nutritionisit if needed", "OK");
        //        }
        //        else if (bmi >= 18 && bmi < 24)
        //        {
        //            await DisplayAlert("BMI", "Gender: Female\nBMI: " + bmiString + "\nHealth Satus: Normal Weight\nReccomendations:\n  -Maintain a balanced diet with proteins, healthy fats, and fiber.\n  -Stay physically active with at least 150 minutes of exercise per week.\nKeep regular check-ups to monitor overall health.", "OK");
